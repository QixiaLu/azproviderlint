...
| [AZR007](checks/AZR/AZR007_wait_for_state_context) | `pluginsdk.StateChangeConf` must not be used — prefer a custom poller implementing `pollers.PollerType` driven via `pollers.NewPoller(...).PollUntilDone(ctx)` |
