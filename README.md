...
| Rule | Description |
|------|-------------|
| [AZS001](checks/AZS/AZS001_typed_sdk_model_64bit_types) | typed sdk models must use explicit 64 bit |
| [AZS002](checks/AZS/AZS002_schema_default_type_mismatch) | schema defaults must match the declared type |
| [AZS003](checks/AZS/AZS003_schema_allows_empty_block) | optional blocks must not allow empty blocks |
| [AZS004](checks/AZS/AZS004_enum_validation_possible_values) | enum validation must use the possible values helper |
| [AZS005](checks/AZS/AZS005_resource_missing_data_source) | resources should have a matching data source |
| [AZS006](checks/AZS/AZS006_data_source_missing_properties) | data sources must expose all the resource's properties |
